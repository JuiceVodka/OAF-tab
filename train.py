...
def train(logdir, device, iterations, resume_iteration, checkpoint_interval, train_on, batch_size, sequence_length,
    ...
    if train_on == 'MAESTRO':
        ...
        dataset = GuitarSet(groups=['00', '01', '02', '03', '04'], sequence_length=int(sequence_length/2))
        validation_dataset = GuitarSet(groups=['05'], sequence_length=int(sequence_length/2))
